  ...
  return (
    <>
      {data?.map((property, PageArticles) => {
        return (
          /* CARD --*/
          <div className="rounded-xl shadow-ms shadow-md shadow-lg border border-sky-900" key={PageArticles}>
            <div className="p-3 flex-auto flex-col ">
              ...
              <p class="text-m ">{moment(property.publishedAt).format('MMMM Do YYYY, h:mm:ss a')}</p>
              </div>
